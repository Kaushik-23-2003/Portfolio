...
const Filters = ({ filterValue, setFilterValue }: FilterProps) => {
  // Define the fixed filter categories
  const filters = ["NLP", "ML/DL", "Web dev", "MERN"];
  ...
  return (
    <div className="flex items-center gap-4 py-8 justify-center max-md:flex-wrap">
      ...
      {filters.map((filter, index) => (
        ...
        >
          <motion.button
            onClick={() => setFilterValue(filter)} // Set filterValue to the category
